...
BEFORE IT CAN SHIP: three registry names that do not exist yet (npm scoped, Packagist, PyPI), so the first publish of each needs the owner -- npm cannot be claimed by OIDC, Packagist needs a one-time submit AFTER the first tag, PyPI needs a pending publisher BEFORE it. Run `.claude/skills/ship-it/preflight.py` and hand over the numbered steps rather than improvising them.',
    ...
    private const META = [
        ...
        'prism' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-harness' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-human-plus' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-mcp' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-opentelemetry' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-perplexity' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-workspace' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-memory' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-browser' => ['group' => 'platform', 'ecosystem' => 'polyglot', 'kind' => 'headless', 'accent' => '#a855f7'],
