...
export function RadarDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Radar" description="Single-series radar chart.">
        <EChart
          option={{
            tooltip: {},
      ...
      <DemoSection title="Multi-Series Radar" description="Comparing two data series on a radar.">
        <EChart
          option={{
            tooltip: {},
            legend: {},
      ...
      <DemoSection title="Filled Radar" description="Radar with area fill and custom colors.">
        <EChart
          option={{
            tooltip: {},
