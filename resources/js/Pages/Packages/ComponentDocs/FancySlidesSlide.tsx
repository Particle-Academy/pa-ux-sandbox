...
<Slide slide={slide} theme={darkTheme} />`,
    ...
    props: [
        ...
        { name: "editing", type: `boolean`, default: `false`, description: "Enable editing affordances — element click-to-select, pointer drag-to-move, 8 resize handles when an element is selected, and an editable textarea on selected text elements." },
        ...
        { name: "onElementSelect", type: `(elementId: string | null) => void`, default: "—", description: "Called when an element is clicked / pointer-up without movement — host-driven selection." },
        { name: "onElementMove", type: `(elementId, x, y) => void`, default: "—", description: "Called as the user drags an element body. x/y are slide-relative (0..1), clamped to keep the element on-slide." },
        { name: "onElementResize", type: `(elementId, { x, y, w, h }) => void`, default: "—", description: "Called as the user drags one of the 8 resize handles. Returns the full new bounding box (clamped, min dimension 0.02)." },
