...
export function SankeyDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Sankey" description="Flow diagram showing resource allocation." code={`<EChart
  option={{
    series: [{
      type: "sankey",
...
/>`}>
      ...
      <DemoSection title="Vertical Sankey" description="Sankey with vertical orientation." code={`<EChart
  option={{
    series: [{
      type: "sankey",
      orient: "vertical",
