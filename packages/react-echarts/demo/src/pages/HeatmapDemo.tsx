...
export function HeatmapDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Heatmap" description="Activity heatmap showing hours vs days.">
        <EChart
          option={{
      ...
      <DemoSection title="Large Heatmap" description="Heatmap with more data points and gradient colors.">
        <EChart
          option={{
            tooltip: { position: "top" },
