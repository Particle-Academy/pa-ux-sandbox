...
export default defineConfig({
    ...
    resolve: {
        ...
        alias: {
            ...
            '@particle-academy/agent-integrations/bridges/flow': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/flow.ts'),
            '@particle-academy/agent-integrations/bridges/forms': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/forms.ts'),
            '@particle-academy/agent-integrations/bridges/sheets': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/sheets.ts'),
            '@particle-academy/agent-integrations/bridges/code': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/code.ts'),
            '@particle-academy/agent-integrations/bridges/charts': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/charts.ts'),
            '@particle-academy/agent-integrations/bridges/scene': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/scene.ts'),
            '@particle-academy/agent-integrations/bridges/screens': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/screens.ts'),
            '@particle-academy/agent-integrations/bridges/slides': path.resolve(__dirname, 'packages/agent-integrations/src/bridges/slides.ts'),
            '@particle-academy/agent-integrations/components/shared-whiteboard': path.resolve(__dirname, 'packages/agent-integrations/src/components/SharedWhiteboard'),
            ...
            '@particle-academy/fancy-slides/registry': path.resolve(__dirname, 'packages/fancy-slides/src/registry'),
