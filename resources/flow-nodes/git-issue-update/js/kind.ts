...
import { gitIssueUpdateKind } from "../ui/kind";
import { gitIssueUpdateExecutor } from "./executor";
 ...
 */
export const gitIssueUpdateRunnableKind: NodeKindDefinition = {
  ...gitIssueUpdateKind,
  executor: gitIssueUpdateExecutor,
};
