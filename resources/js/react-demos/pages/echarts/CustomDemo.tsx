...
export function CustomDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Custom Rectangles" description="Custom series rendering rectangles with renderItem." code={`<EChart
  option={{
...
/>`}>
      ...
      <DemoSection title="Error Bars" description="Custom series for error bars on a line chart." code={`<EChart
  option={{
