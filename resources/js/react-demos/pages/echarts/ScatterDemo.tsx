...
export function ScatterDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Scatter" description="Simple scatter plot." code={`<EChart
  option={{
    xAxis: { type: "value" },
    yAxis: { type: "value" },
...
/>`}>
      ...
      <DemoSection title="Multi-Series" description="Scatter with multiple groups." code={`<EChart
  option={{
    xAxis: { type: "value" },
    yAxis: { type: "value" },
    legend: {},
...
/>`}>
      ...
      <DemoSection title="Bubble Chart" description="Scatter with varying symbol sizes." code={`<EChart
  option={{
    xAxis: { type: "value" },
    yAxis: { type: "value" },
    series: [{
