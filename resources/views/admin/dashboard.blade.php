...
<div class="space-y-6">
    <div>
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Custom admin interface using Catalog and FMS facades
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['active_products'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Prices</dt>
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['prices'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Synced to Stripe</dt>
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ $stats['synced_products'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <svg class="h-6 w-6 {{ $stats['stripe_connected'] ? 'text-green-400' : 'text-red-400' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                    </div>
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Stripe Connection</dt>
                            <dd class="text-lg font-medium {{ $stats['stripe_connected'] ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                {{ $stats['stripe_connected'] ? 'Connected' : 'Disconnected' }}
                            </dd>
                        </dl>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Enabled Features</dt>
                            <dd class="text-lg font-medium text-gray-900 dark:text-white">{{ count($enabledFeatures) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Enabled Features (FMS)</h3>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="{{ route('admin.plans.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    View Plans
                </a>
