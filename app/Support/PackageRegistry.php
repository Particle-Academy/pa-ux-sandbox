...
BEFORE IT CAN SHIP: the npm name does not exist yet, so the first publish needs the owner -- npm cannot be claimed by OIDC. Run .claude/skills/ship-it/preflight.py and hand over the numbered steps rather than improvising them.',
    ...
    private const META = [
        ...
        'prism-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-py' => ['group' => 'platform', 'ecosystem' => 'py', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-browser-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-browser-py' => ['group' => 'platform', 'ecosystem' => 'py', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-harness-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-harness-py' => ['group' => 'platform', 'ecosystem' => 'py', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-human-plus-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-mcp-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-memory-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-memory-py' => ['group' => 'platform', 'ecosystem' => 'py', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-opentelemetry-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-perplexity-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
        'prism-workspace-ts' => ['group' => 'platform', 'ecosystem' => 'ts', 'kind' => 'headless', 'accent' => '#a855f7'],
    ...
    private static function companionRows(): array
    {
        return array_map(self::classify(...), [
            ...
            // The Prism PORTS. Each language is its own package with its own
            // repo and its own release cadence, so each is its own entry --
            // the same shape as holy-sheet / holy-sheet-js / holy-sheet-py.
            //
            // Folding them into the PHP entry as extra `npm` / `pypi` fields
            // was tried first and is wrong: it makes the PHP package MENTION
            // npm without listing the TS package at all, so the ports stay
            // absent from /packages, kit:status and every MCP search.
            //
            // Nine TS ports, all published. Four Python ports: the other five
            // declare a name in pyproject.toml and 404 on PyPI, and announcing
            // something that cannot be installed is worse than saying nothing.
            [
                'slug' => 'prism-ts',
                'name' => '@particle-academy/prism',
                'tagline' => 'Node/TS port of prism -- Unified text / structured / streaming across providers, with per-run spend attribution.',
                'npm' => '@particle-academy/prism',
                'repo' => 'Particle-Academy/prism-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-browser-ts',
                'name' => '@particle-academy/prism-browser',
                'tagline' => 'Node/TS port of prism-browser -- Guarded browser automation -- bounded observations and policy-first navigation.',
                'npm' => '@particle-academy/prism-browser',
                'repo' => 'Particle-Academy/prism-browser-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-harness-ts',
                'name' => '@particle-academy/prism-harness',
                'tagline' => 'Node/TS port of prism-harness -- Durable agent sessions -- threads, modes, tool permissions and subagents.',
                'npm' => '@particle-academy/prism-harness',
                'repo' => 'Particle-Academy/prism-harness-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-human-plus-ts',
                'name' => '@particle-academy/prism-human-plus',
                'tagline' => 'Node/TS port of prism-human-plus -- Human+ participant presence -- an agent session joins live Fancy surfaces.',
                'npm' => '@particle-academy/prism-human-plus',
                'repo' => 'Particle-Academy/prism-human-plus-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-mcp-ts',
                'name' => '@particle-academy/prism-mcp',
                'tagline' => 'Node/TS port of prism-mcp -- Model Context Protocol -- consume remote MCP tools as ordinary Prism tools.',
                'npm' => '@particle-academy/prism-mcp',
                'repo' => 'Particle-Academy/prism-mcp-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-memory-ts',
                'name' => '@particle-academy/prism-memory',
                'tagline' => 'Node/TS port of prism-memory -- Persistent context and semantic recall -- vector storage, remember / recall.',
                'npm' => '@particle-academy/prism-memory',
                'repo' => 'Particle-Academy/prism-memory-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-opentelemetry-ts',
                'name' => '@particle-academy/prism-opentelemetry',
                'tagline' => 'Node/TS port of prism-opentelemetry -- OpenTelemetry bridge -- Prism telemetry as GenAI-convention spans.',
                'npm' => '@particle-academy/prism-opentelemetry',
                'repo' => 'Particle-Academy/prism-opentelemetry-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-perplexity-ts',
                'name' => '@particle-academy/prism-perplexity',
                'tagline' => 'Node/TS port of prism-perplexity -- The rest of the Perplexity API -- embeddings, direct search, deep research.',
                'npm' => '@particle-academy/prism-perplexity',
                'repo' => 'Particle-Academy/prism-perplexity-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-workspace-ts',
                'name' => '@particle-academy/prism-workspace',
                'tagline' => 'Node/TS port of prism-workspace -- Sandboxed, session-scoped agent workspaces behind a path guard.',
                'npm' => '@particle-academy/prism-workspace',
                'repo' => 'Particle-Academy/prism-workspace-ts',
                'language' => 'TypeScript',
            ],
            [
                'slug' => 'prism-py',
                'name' => 'prism-ai-core',
                'tagline' => 'Python port of prism -- Unified text / structured / streaming across providers, with per-run spend attribution.',
                'pypi' => 'prism-ai-core',
                'repo' => 'Particle-Academy/prism-py',
                'language' => 'Python',
            ],
            [
                'slug' => 'prism-browser-py',
                'name' => 'prism-ai-browser',
                'tagline' => 'Python port of prism-browser -- Guarded browser automation -- bounded observations and policy-first navigation.',
                'pypi' => 'prism-ai-browser',
                'repo' => 'Particle-Academy/prism-browser-py',
                'language' => 'Python',
            ],
            [
                'slug' => 'prism-harness-py',
                'name' => 'prism-ai-harness',
                'tagline' => 'Python port of prism-harness -- Durable agent sessions -- threads, modes, tool permissions and subagents.',
                'pypi' => 'prism-ai-harness',
                'repo' => 'Particle-Academy/prism-harness-py',
                'language' => 'Python',
            ],
            [
                'slug' => 'prism-memory-py',
                'name' => 'prism-ai-memory',
                'tagline' => 'Python port of prism-memory -- Persistent context and semantic recall -- vector storage, remember / recall.',
                'pypi' => 'prism-ai-memory',
                'repo' => 'Particle-Academy/prism-memory-py',
                'language' => 'Python',
            ],
            [
                'slug' => 'holy-sheet-js',
    ...
    private static function componentsForReactFancy(): array
    {
        ...
        $components = array_map(fn (array $r) => $r + [
            ...
            ['slug' => 'select', 'name' => 'Select', 'blurb' => 'Native or searchable listbox selection, including grouped and multi-select options.', 'vendor' => false],
            ['slug' => 'checkbox', 'name' => 'Checkbox', 'blurb' => 'Accessible boolean checkbox with controlled, indeterminate and validation states.', 'vendor' => false],
            ['slug' => 'checkbox-group', 'name' => 'CheckboxGroup', 'blurb' => 'Controlled multiple-choice checkbox group with horizontal and vertical layouts.', 'vendor' => false],
            ['slug' => 'radio-group', 'name' => 'RadioGroup', 'blurb' => 'Controlled single-choice radio group with accessible labels and descriptions.', 'vendor' => false],
            ['slug' => 'switch', 'name' => 'Switch', 'blurb' => 'Boolean toggle switch with controlled state, colors, labels and form support.', 'vendor' => false],
            ['slug' => 'slider', 'name' => 'Slider', 'blurb' => 'Single-value or range slider with marks and visible value formatting.', 'vendor' => false],
            ['slug' => 'multi-switch', 'name' => 'MultiSwitch', 'blurb' => 'Segmented toggle switch for selecting one value from multiple options.', 'vendor' => false],
            ['slug' => 'date-picker', 'name' => 'DatePicker', 'blurb' => 'Single-date, date-time or date-range input with controlled values.', 'vendor' => false],
