...
export function ThemeRiverDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Theme River" description="Streamgraph showing topic trends over time.">
        <EChart
          option={{
      ...
      <DemoSection title="Styled Theme River" description="Theme river with custom colors.">
        <EChart
          option={{
