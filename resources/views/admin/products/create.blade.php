...
<div class="max-w-2xl">
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Create a new product using Catalog facade
        </p>
    </div>

    <form action="{{ route('admin.products.store') }}" method="POST" class="bg-white dark:bg-gray-800 shadow rounded-lg">
        @csrf
        ...
        <div class="px-4 py-3 bg-gray-50 dark:bg-gray-700 sm:px-6 flex justify-end space-x-3">
            <a href="{{ route('admin.products.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
                Cancel
            </a>
