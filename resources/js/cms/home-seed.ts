...
export const homeDoc: PageDoc = {
  ...
  nodes: {
    ...
    "qs-sub": { id: "qs-sub", type: "richtext", parent: "qs-container", order: "c", className: "section-sub", props: { html: 'Install the npm package and import it, or vendor the source with <code>npx fancy-cli add</code> and own the code. PHP packages install with <code>composer require</code>. Either way, point your coding agent at our hosted registry MCP — <code>ui.particle.academy/mcp</code> — and it\'ll search the registry and return the exact install commands.' }, style: { base: {} } },
