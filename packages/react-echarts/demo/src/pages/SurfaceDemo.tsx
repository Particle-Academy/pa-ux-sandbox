...
export function SurfaceDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Mathematical Surface" description="3D surface plot of a mathematical function.">
        <EChart3D
          option={{
            tooltip: {},
      ...
      <DemoSection title="Wavy Surface" description="Surface with wave-like pattern.">
        <EChart3D
          option={{
            tooltip: {},
            xAxis3D: { type: "value" },
