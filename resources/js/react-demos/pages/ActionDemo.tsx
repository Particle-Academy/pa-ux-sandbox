...
<Action emoji="fire" emojiTrailing="100">Perfect</Action>`}>
      ...
      {/* Avatar & Badge */}
      <DemoSection title="Avatar & Badge" description="Avatar images and badge text." code={`<Action avatar="/avatar.jpg">John Doe</Action>
...
<Action badge="New" badgeTrailing color="blue">Update</Action>`}>
      ...
      {/* Circle Variant */}
      <DemoSection title="Circle Variant" description="Icon-only circular buttons." code={`<Action variant="circle" icon="plus" />
...
<Action ... sort="biae">Sort: biae</Action>`}>
...
<Action loading variant="circle" />`}>
      ...
      {/* As Link */}
      <DemoSection title="As Link" description="Rendered as an anchor tag." code={`<Action href="https://example.com">Visit</Action>
<Action href="/page" color="blue" icon="chevron-right" iconPlace="right">
  Go to Site
</Action>`}>
        <div className="flex items-center gap-3">
