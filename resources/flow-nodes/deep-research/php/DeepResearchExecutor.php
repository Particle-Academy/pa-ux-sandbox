...
#[FlowNode(
    ...
    configSchema: [
        [
            ...
            'rows' => 4,
            'required' => true,
            'placeholder' => 'What should be investigated and synthesized?',
        ],
        [
            'key' => 'instructions',
            'label' => 'Instructions',
            'type' => 'textarea',
            'rows' => 3,
            'placeholder' => 'Prioritize primary sources and explain disagreements.',
        ],
        [
            'key' => 'depth',
            'label' => 'Depth',
        ...
        [
            ...
            'type' => 'text',
            'description' => 'Resolved by the host; never store a raw API key here.',
        ],
    ],
