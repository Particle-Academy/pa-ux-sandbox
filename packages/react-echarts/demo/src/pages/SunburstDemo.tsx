...
export function SunburstDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Sunburst" description="Hierarchical data displayed as concentric rings.">
        <EChart
          option={{
            tooltip: {},
            series: [{
      ...
      <DemoSection title="Styled Sunburst" description="Sunburst with rounded corners and emphasis.">
        <EChart
          option={{
            tooltip: {},
            series: [{
