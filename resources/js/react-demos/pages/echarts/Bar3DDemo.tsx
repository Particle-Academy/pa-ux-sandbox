...
export function Bar3DDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic 3D Bar" description="3D bar chart with grid." code={`<EChart3D
  option={{
...
/>`}>
      ...
      <DemoSection title="Styled 3D Bar" description="3D bar with custom colors and lighting." code={`<EChart3D
  option={{
