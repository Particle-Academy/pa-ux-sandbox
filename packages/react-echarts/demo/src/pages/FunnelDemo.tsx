...
export function FunnelDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Funnel" description="Conversion funnel showing stages.">
        <EChart
          option={{
      ...
      <DemoSection title="Ascending Funnel" description="Inverted funnel with sort ascending.">
        <EChart
          option={{
      ...
      <DemoSection title="Comparison Funnel" description="Side-by-side funnels for comparison.">
        <EChart
          option={{
            tooltip: { trigger: "item" },
            legend: {},
