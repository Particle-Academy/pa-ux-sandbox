...
import { stripePaymentIntentKind } from "../ui/kind";
import { stripePaymentIntentExecutor } from "./executor";
 ...
 */
export const stripePaymentIntentRunnableKind: NodeKindDefinition = {
