...
export function CandlestickDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Candlestick" description="OHLC candlestick chart for stock data." code={`<EChart
  option={{
...
/>`}>
      ...
      <DemoSection title="With Volume" description="Candlestick with volume bars and data zoom." code={`<EChart
  option={{
