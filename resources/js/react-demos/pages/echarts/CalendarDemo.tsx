...
export function CalendarDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Calendar" description="GitHub-style contribution calendar." code={`<EChart
  option={{
...
/>`}>
      ...
      <DemoSection title="Multi-Year Calendar" description="Stacked calendars for multiple years." code={`<EChart
  option={{
