...
class ConnectorRegistryController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            // No `$schema`. The catalogue is generated by weaver.agi and its
            // shape is still moving, so no schema is maintained for it — and a
            // `$schema` URL that 404s is worse than none. PublishedSchemasTest
            // fails on any schema URL this app names without serving it.
