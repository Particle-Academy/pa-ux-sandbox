...
export function TreemapDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Treemap" description="Hierarchical data as nested rectangles.">
        <EChart
          option={{
            tooltip: {},
            series: [{
      ...
      <DemoSection title="Styled Treemap" description="Treemap with custom colors and levels.">
        <EChart
          option={{
