...
export function BoxplotDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Boxplot" description="Statistical box-and-whisker plot.">
        <EChart
          option={{
      ...
      <DemoSection title="Horizontal Boxplot" description="Horizontal orientation with outliers.">
        <EChart
          option={{
