...
export function LineDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Line" description="Simple line chart with category axis.">
        <EChart
          option={{
      ...
      <DemoSection title="Smooth Line" description="Line chart with smooth curves and area fill.">
        <EChart
          option={{
            xAxis: { type: "category", data: months },
            yAxis: { type: "value" },
      ...
      <DemoSection title="Multi-Series" description="Multiple lines with legend.">
        <EChart
          option={{
            xAxis: { type: "category", data: months },
            yAxis: { type: "value" },
      ...
      <DemoSection title="Stacked Area" description="Stacked area chart with gradient fill.">
        <EChart
          option={{
