...
export const actionDoc: ComponentDoc = {
    intro: (
        <>
            <code>Action</code> is the one-and-only button primitive in
    ...
    examples: [
        {
            name: "Default",
            description: "Plain Action — neutral surface, label only. Everything else is opt-in.",
            render: () => (
        ...
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Action variant="circle" icon="bell" />
                    <Action variant="circle" icon="trash" color="red" />
                </div>
            ),
            code: `<Action variant="default">Default</Action>
<Action variant="ghost">Ghost</Action>
<Action variant="circle" icon="bell" />
<Action variant="circle" icon="trash" color="red" />`,
        },
        {
            ...
            code: `<Action color="violet">Violet</Action>
<Action color="indigo">Indigo</Action>
<Action color="blue">Blue</Action>
<Action color="sky">Sky</Action>
<Action color="emerald">Emerald</Action>
        ...
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action size="xs">xs</Action>
                    <Action size="sm">sm</Action>
                    <Action size="md">md</Action>
                    <Action size="lg">lg</Action>
                    <Action size="xl">xl</Action>
                </div>
            ),
            code: `<Action size="xs">xs</Action>
<Action size="sm">sm</Action>
<Action size="md">md</Action>
<Action size="lg">lg</Action>
<Action size="xl">xl</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Action warn icon="exclamation-triangle">Warning</Action>
                    <Action alert icon="bell">Alert</Action>
                    <Action color="red" alert icon="bell">Red + alert</Action>
                </div>
            ),
            code: `<Action active>Active</Action>
<Action checked icon="check">Checked</Action>
<Action warn icon="exclamation-triangle">Warning</Action>
<Action alert icon="bell">Alert</Action>
<Action color="red" alert icon="bell">Red + alert</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Action icon="trash" color="red">Delete</Action>
                    <Action iconTrailing="arrow-right" color="violet">Continue</Action>
                    <Action iconTrailing="chevron-down">More</Action>
                </div>
            ),
...
<Action iconTrailing="chevron-down">More</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action icon="bars-3" iconPlace="top">Menu</Action>
                    <Action icon="adjustments-horizontal" iconPlace="top">Filters</Action>
                    <Action icon="bookmark" iconPlace="bottom">Save</Action>
                    <Action icon="information-circle" iconPlace="right">Info</Action>
                </div>
            ),
            code: `<Action icon="bars-3" iconPlace="top">Menu</Action>
<Action icon="adjustments-horizontal" iconPlace="top">Filters</Action>
<Action icon="bookmark" iconPlace="bottom">Save</Action>
<Action icon="information-circle" iconPlace="right">Info</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action emoji="fire" color="red">Hot</Action>
                    <Action emoji="rocket" color="violet">Launch</Action>
                    <Action emojiTrailing="thumbs-up">Like</Action>
                    <Action emoji="party-popper" emojiTrailing="sparkles">Celebrate</Action>
                </div>
            ),
            code: `<Action emoji="fire" color="red">Hot</Action>
<Action emoji="rocket" color="violet">Launch</Action>
<Action emojiTrailing="thumbs-up">Like</Action>
<Action emoji="party-popper" emojiTrailing="sparkles">Celebrate</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action avatar="https://github.com/anthropic.png">Anthropic</Action>
                    <Action avatar="https://github.com/vercel.png" variant="ghost">Vercel</Action>
                    <Action avatar="https://github.com/laravel.png" avatarTrailing color="red">Laravel</Action>
                </div>
            ),
            code: `<Action avatar="https://github.com/anthropic.png">Anthropic</Action>
<Action avatar="https://github.com/vercel.png" variant="ghost">Vercel</Action>
<Action avatar="https://github.com/laravel.png" avatarTrailing color="red">Laravel</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action icon="bell" badge="3">Notifications</Action>
                    <Action icon="inbox" badge="12" color="violet">Inbox</Action>
                    <Action badge="NEW" color="emerald">Featured</Action>
                    <Action icon="cog" badge="beta" color="amber">Settings</Action>
                </div>
            ),
            code: `<Action icon="bell" badge="3">Notifications</Action>
<Action icon="inbox" badge="12" color="violet">Inbox</Action>
<Action badge="NEW" color="emerald">Featured</Action>
<Action icon="cog" badge="beta" color="amber">Settings</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action icon="star" emoji="fire" badge="HOT" sort="eib">Default eib</Action>
                    <Action icon="star" emoji="fire" badge="HOT" sort="bie">Reversed bie</Action>
                    <Action icon="star" emoji="fire" badge="HOT" sort="ibe">Icon first</Action>
                </div>
            ),
            code: `<Action icon="star" emoji="fire" badge="HOT" sort="eib">Default eib</Action>
<Action icon="star" emoji="fire" badge="HOT" sort="bie">Reversed bie</Action>
<Action icon="star" emoji="fire" badge="HOT" sort="ibe">Icon first</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Action loading color="violet">Uploading</Action>
                    <Action loading variant="circle" />
                    <Action loading disabled>Working</Action>
                </div>
            ),
...
<Action loading disabled>Working</Action>`,
        },
        {
            ...
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action disabled>Submit</Action>
                    <Action disabled color="violet" icon="rocket">Launch</Action>
                    <Action disabled variant="ghost">Cancel</Action>
                </div>
            ),
            code: `<Action disabled>Submit</Action>
<Action disabled color="violet" icon="rocket">Launch</Action>
<Action disabled variant="ghost">Cancel</Action>`,
        },
        {
            name: "As an anchor",
            description: "Pass `href` and the Action renders as `<a>` instead of `<button>` — drop-in replacement for nav links that want button styling. Combine with `iconTrailing` for the canonical \"learn more →\" pattern.",
            render: () => (
                <div className="flex flex-wrap items-center gap-2">
                    <Action href="#" iconTrailing="arrow-right">Read the docs</Action>
                    <Action href="#" color="violet" icon="arrow-down-tray">Download zip</Action>
                    <Action href="#" variant="ghost" iconTrailing="arrow-top-right-on-square">View on GitHub</Action>
                </div>
            ),
            code: `<Action href="/docs" iconTrailing="arrow-right">Read the docs</Action>
<Action href="/download" color="violet" icon="arrow-down-tray">Download zip</Action>
<Action href="https://github.com/..." variant="ghost" iconTrailing="arrow-top-right-on-square">View on GitHub</Action>`,
        },
        {
            name: "Kitchen sink",
...
>
  anthropic
    ...
    notes: (
        <>
            <strong>Accessibility:</strong> Action renders a real{" "}
