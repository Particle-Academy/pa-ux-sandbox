...
import { gitPrChecksKind } from "../ui/kind";
import { gitPrChecksExecutor } from "./executor";
 ...
 */
export const gitPrChecksRunnableKind: NodeKindDefinition = {
  ...gitPrChecksKind,
  executor: gitPrChecksExecutor,
};
