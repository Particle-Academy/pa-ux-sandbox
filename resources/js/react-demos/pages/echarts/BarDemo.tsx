...
export function BarDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Bar" description="Simple vertical bar chart." code={`<EChart
  option={{
...
/>`}>
      ...
      <DemoSection title="Horizontal Bar" description="Horizontal bar chart with inverted axes." code={`<EChart
  option={{
...
/>`}>
      ...
      <DemoSection title="Stacked Bar" description="Stacked bar chart with multiple series." code={`<EChart
  option={{
...
/>`}>
      ...
      <DemoSection title="With DataZoom" description="Bar chart with interactive data zoom slider." code={`<EChart
  option={{
    xAxis: { type: "category", data: [...] },
    yAxis: { type: "value" },
