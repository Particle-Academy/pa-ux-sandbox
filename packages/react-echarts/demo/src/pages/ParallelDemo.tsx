...
export function ParallelDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Parallel" description="Multi-dimensional data visualization.">
        <EChart
          option={{
            parallelAxis: [
              { dim: 0, name: "Index" },
      ...
      <DemoSection title="Interactive Parallel" description="Parallel coordinates with axis brush filtering.">
        <EChart
          option={{
            parallelAxis: [
