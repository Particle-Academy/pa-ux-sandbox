...
export function MapDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Note" description="To use actual map charts, register GeoJSON data with echarts.registerMap(). See the ECharts documentation for supported map data sources.">
