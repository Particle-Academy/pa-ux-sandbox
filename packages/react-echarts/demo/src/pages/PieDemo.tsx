...
export function PieDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic Pie" description="Simple pie chart with labels.">
        <EChart
          option={{
      ...
      <DemoSection title="Doughnut" description="Pie chart with inner radius (doughnut style).">
        <EChart
          option={{
            tooltip: { trigger: "item" },
            legend: { top: "bottom" },
      ...
      <DemoSection title="Rose Chart" description="Nightingale rose chart with varying radius.">
        <EChart
          option={{
            tooltip: { trigger: "item" },
            legend: { top: "bottom" },
      ...
      <DemoSection title="Nested Pie" description="Multi-ring nested pie chart.">
        <EChart
          option={{
            tooltip: { trigger: "item" },
            series: [
