...
export function GraphDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Force Layout" description="Network graph with force-directed layout." code={`<EChart
  option={{
    series: [{
      type: "graph",
      layout: "force",
...
/>`}>
      ...
      <DemoSection title="Circular Layout" description="Network arranged in a circle." code={`<EChart
  option={{
    series: [{
      type: "graph",
      layout: "circular",
