...
export function Scatter3DDemo(): React.ReactElement {
  return (
    <div>
      ...
      <DemoSection title="Basic 3D Scatter" description="3D scatter plot with rotation.">
        <EChart3D
          option={{
            tooltip: {},
            xAxis3D: { type: "value" },
      ...
      <DemoSection title="Multi-Group Scatter" description="3D scatter with multiple colored groups.">
        <EChart3D
          option={{
            tooltip: {},
            legend: {},
