...
export const homeDoc: PageDoc = {
  ...
  nodes: {
    ...
    "qs-sub": { id: "qs-sub", type: "richtext", parent: "qs-container", order: "c", className: "section-sub", props: { html: 'Install the npm package and import it, or vendor the source with <code>npx fancy-cli@latest add</code> and own the code. PHP packages install with <code>composer require</code>. Either way, point your coding agent at our hosted registry MCP — <code>ui.particle.academy/mcp</code> — and it\'ll search the registry and return the exact install commands.' }, style: { base: {} } },
    ...
    "qs-mcp": { id: "qs-mcp", type: "richtext", parent: "qs-container", order: "e", className: "qs-mcp", props: { html: `<div class="qs-mcp-copy"><div class="qs-mcp-title"><span class="qs-mcp-dot"></span> Or let your agent do it</div><p>There&apos;s a plugin for <a href="https://github.com/Particle-Academy/fancy-ui-plugin" target="_blank" rel="noopener noreferrer">Claude Code</a> and one for <a href="https://github.com/Particle-Academy/fancy-ui-codex-plugin" target="_blank" rel="noopener noreferrer">Codex</a> — either wires up the hosted registry MCP <em>and</em> bundles skills for architecture, components, design, realtime, SEO and SSR. Any other MCP client drops the hosted server into its config; no API key. Your agent then calls <code>list-components</code>, <code>search-components</code>, and <code>install-instructions</code> against the live registry — no guessing from memory.</p></div><div class="codeblock">${MCP_CODE}</div>` }, style: { base: {} } },
